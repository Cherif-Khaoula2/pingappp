...
export default function FindAllComputersLaps() {
  ...
  return (
    <Layout>
      ...
      <style>{`
        :global(.p-card) { border-radius: 12px; border: 1px solid #e5e7eb; }
        :global(.p-datatable .p-datatable-header) { background: white; padding: 1rem; border-bottom: 1px solid #e5e7eb; }
        :global(.p-datatable .p-datatable-tbody > tr:hover) { background: #f9fafb; }
        :global(.p-inputtext) { border-radius: 8px; border: 1px solid #e5e7eb; padding: 0.5rem; }
        :global(.p-button) { border-radius: 8px; font-weight: 600; margin-left: 0.25rem; }
      `}</style>
    </Layout>
  );
}
